        ...
        <div className="vn-rise mt-6 grid grid-cols-2 gap-3 lg:grid-cols-4 lg:gap-4">
          {visibleArticles.map((article) => (
            <div
              ...
              className="group relative flex aspect-[4/5] cursor-pointer flex-col overflow-hidden rounded-xl border border-(--crm-border-soft) bg-white p-3 text-left shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-(--crm-border-input) hover:shadow-[0_8px_24px_rgba(0,0,0,.10)] sm:p-4"
            >
      ...
      {slider !== null && (
        <div className="fixed inset-0 z-[70] flex justify-end">
          ...
          <div className="crm-slide-in relative flex h-full w-full max-w-[680px] flex-col border-l border-(--crm-border) bg-(--crm-panel) shadow-2xl">
            ...
            {slider === "new" && (
              <>
                <div className="flex items-center justify-between border-b border-(--crm-border) px-4 py-3 sm:px-6 sm:py-4">
                  <h3 className="text-sm font-semibold sm:text-base">New Article</h3>
            ...
            {slider !== "new" && (
              <>
                <div className="flex items-center justify-between border-b border-(--crm-border) px-4 py-3 sm:px-6 sm:py-4">
                  <h3 className="truncate text-sm font-semibold sm:text-base">{slider.title}</h3>
                  <button onClick={() => setSlider(null)} className="rounded-lg p-1 text-(--crm-muted) hover:bg-(--crm-hover)"><X size={16} /></button>
                </div>
